...
@configclass
class G1FlatDeepPPORunnerCfg(G1FlatPPORunnerCfg):
    """Teacher-provided capacity ablation; all PPO settings remain unchanged."""

    def __post_init__(self):
        super().__post_init__()
        self.policy.actor_hidden_dims = [512, 1024, 256, 128]
