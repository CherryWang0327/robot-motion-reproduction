...
```mermaid
flowchart TD
    A([march_video_motionlib_pyroki.pt<br/>PyRoki 重定向的 G1 动作]) --> B[pt_to_npz_local.py<br/>转换为 50 FPS WBT NPZ]
    B --> C([march_video_motionlib_pyroki_proto.npz<br/>WBT 参考动作])
